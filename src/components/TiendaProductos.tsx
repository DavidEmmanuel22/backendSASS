...
import { Search, ShoppingCart, Heart, Star, Gift, Tag, Store as StoreIcon, Coffee, Sandwich, Croissant, Droplets } from 'lucide-react';
          ...
          <div className="flex gap-2 overflow-x-auto pb-2">
            {categorias.map((categoria) => (
              <Button
                ...
                className={categoriaActiva === categoria.id ? 'bg-teal-600 hover:bg-teal-700' : ''}
              >
                {categoria.label}
              </Button>
            ))}
