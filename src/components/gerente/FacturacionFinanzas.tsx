    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 text-sm">
            Control financiero y gestión de proveedores
          </p>
        </div>
      ...
      <Tabs defaultValue="facturas">
        <TabsList className="grid w-full grid-cols-4">
          ...
          <TabsTrigger value="cobros">Cobros/Impagos</TabsTrigger>
        ...
        <TabsContent value="facturas" className="space-y-6 mt-6">
          ...
          <div className="grid md:grid-cols-4 gap-4">
            <Card className="border-2 border-teal-200">
              <CardContent className="pt-6">
                <div className="text-center">
                  ...
                  <p className="text-xs text-gray-500 mt-1">{proveedoresActivos} activos</p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border-2 border-blue-200">
              <CardContent className="pt-6">
                <div className="text-center">
                  <p className="text-sm text-gray-600 mb-1">Materia Prima</p>
                  <p className="text-3xl text-blue-600" style={{ fontFamily: 'Poppins, sans-serif' }}>
                    {proveedoresMateriaPrima}
                  </p>
                  <p className="text-xs text-gray-500 mt-1">proveedores</p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border-2 border-purple-200">
              <CardContent className="pt-6">
                <div className="text-center">
                  ...
                  <p className="text-3xl text-purple-600" style={{ fontFamily: 'Poppins, sans-serif' }}>
            ...
            <Card className="border-2 border-green-200">
              <CardContent className="pt-6">
                <div className="text-center">
                  ...
                  <p className="text-xs text-gray-500 mt-1">{totalPedidos} pedidos</p>
                </div>
              </CardContent>
            </Card>
          </div>
                ...
                <Card className="border-2 border-blue-200">
                  <CardContent className="pt-6">
                    <div className="text-center">
                      ...
                      <p className="text-2xl text-blue-600" style={{ fontFamily: 'Poppins, sans-serif' }}>
                        €{(previsionDias.reduce((acc, d) => acc + d.objetivoVentas, 0)).toLocaleString('es-ES')}
                      </p>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card className="border-2 border-green-200">
                  <CardContent className="pt-6">
                    <div className="text-center">
                      ...
                      <p className="text-2xl text-green-600" style={{ fontFamily: 'Poppins, sans-serif' }}>
                        €{previsionDias[previsionDias.length - 1].acumulado.toLocaleString('es-ES')}
                      </p>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card className="border-2 border-teal-200">
                  <CardContent className="pt-6">
                    <div className="text-center">
                      ...
                      <p className="text-2xl text-teal-600" style={{ fontFamily: 'Poppins, sans-serif' }}>
                        €{(previsionDias.reduce((acc, d) => acc + d.diferencia, 0)).toLocaleString('es-ES')}
                      </p>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card className="border-2 border-purple-200">
                  <CardContent className="pt-6">
                    <div className="text-center">
                      ...
                      <p className="text-2xl text-purple-600" style={{ fontFamily: 'Poppins, sans-serif' }}>
                        {Math.round((previsionDias[previsionDias.length - 1].acumulado / previsionDias.reduce((acc, d) => acc + d.objetivoVentas, 0)) * 100)}%
                      </p>
                    </div>
                  </CardContent>
                </Card>
